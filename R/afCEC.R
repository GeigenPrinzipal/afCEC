afCEC <- function(points, maxClusters, initialLabels="k-means++", cardMin=0.01, minIterations=10, maxIterations=100, numberOfStarts=10, method="Hartigan", values="quadratic", interactive=FALSE) {
